...
class CreateProjectStatusRequest extends Request
{
    /**
    ...
    public function rules()
    {
        return [
            'company_id'=>'required',
            'name'=>'bail|required|unique:projects_status|min:3',
        ];
    }
    ...
    public function messages(){
        return [
            ...
            'name.unique' => trans('project/projectstatus/save.name_unique'),
