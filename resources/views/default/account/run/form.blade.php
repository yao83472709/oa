...
<div class="form-group price_range">
    ...
    <div class="col-sm-3">
        {!! Form::radio('type', '1', true, array('class' => 'name','id'=>'status_in')) !!};
    </div>
    {!! Form::label('status_out',trans('account\fields.run.form.status_out'), array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-3">
        {!! Form::radio('type', '2', false, array('class' => 'name','id'=>'status_out')) !!};
    </div>
</div>
{{--种类名称 --}}
<div class="form-group price_range">
    ...
    <div class="col-sm-10">
        {!! Form::select('account_type',array(trans('account\fields.run.form.select_default')), '0',array('id'=>'select_name','class'=>'form-control')) !!}
    </div>
</div>
{{--付款金额--}}
<div class="hr-line-dashed"></div>
<div class="form-group price_range">
    ...
    <div class="col-sm-10">
        {!! Form::text('money',null,array('id'=>'money','class'=>'form-control')) !!}
    </div>
</div>
{{--摘要--}}
<div class="hr-line-dashed"></div>
