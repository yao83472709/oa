                                ...
                                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="12">
                                    ...
                                    @foreach($datas as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->bonus }}</td>
                                            <td>{{ $data->integral }}</td>
                                            <td>@if(!empty($data->salary)){{ trans('account\common.money_sign') }}{{ $data->salary }}@endif</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                    <tfoot>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $.each(obj,function(n,value) {
                            str+='<tr><td>';
                            if(value['money']!=''){
                                str+="{{ trans('account\common.money_sign') }}"+value['money'];
                            }
                            str+='</td><td>'+value['content']+'</td><td>'+value['name']+'</td></tr>';
                        });
