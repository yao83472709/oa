            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        {!! Form::open(['url'=>'users/store','class'=>'form-horizontal m-t','id'=>'usersForm']) !!}
...
$(document).ready(function () {
    ...
    $("#usersForm").validate({
        ...
        messages: {
            ...
            password: {
                required: icon + "{{ trans('user/save.password_required') }}",
                minlength: icon + "{{ trans('user/save.password_min') }}",
            },
            confirm_password: {
                required: icon + "{{ trans('user/save.confirm_required') }}",
